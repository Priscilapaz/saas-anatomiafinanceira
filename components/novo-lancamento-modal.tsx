...
export function NovoLancamentoModal({ isOpen, onClose, onSave }: NovoLancamentoModalProps) {
  ...
  // Função para criar lançamento via API
  const criarLancamento = async (dadosLancamento: any) => {
    try {
      const BASE_URL = "https://92a839f4-ca69-4644-9ece-3f297c376767-00-1k84q7kulkkda.worf.replit.dev"

      const resposta = await fetch(`${BASE_URL}/lancamentos`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "x-perfil": perfilAtivo,
        },
      ...
      console.error("Erro ao enviar lançamento:", erro)
      throw erro
    }
  }
  ...
  const handleSubmit = async () => {
    try {
      // Criar todos os lançamentos futuros
      for (const lancamento of lancamentosFuturos) {
        ...
        await criarLancamento(dadosLancamento)
      }
  ...
  // Categorias baseadas no perfil
  const categoriasDespesa =
    perfilAtivo === "pessoal"
      ? ["Alimentação", "Transporte", "Moradia", "Saúde", "Educação", "Lazer", "Compras", "Serviços", "Outros"]
      : ["Aluguel", "Funcionários", "Materiais", "Marketing", "Impostos", "Serviços", "Equipamentos", "Outros"]

  const categoriasReceita =
    perfilAtivo === "pessoal"
      ? ["Salário", "Freelances", "Consultoria", "Investimentos", "Vendas", "Outros"]
      : ["Consultório", "Hospital", "Plantões", "Cursos", "Palestras", "Outros"]
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between">
              <span>Novo Lançamento - {perfilAtivo === "pessoal" ? "Pessoal" : "Profissional"}</span>
          ...
          <div className="space-y-3 py-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span>{perfilAtivo === "pessoal" ? "Despesa" : "Custo Operacional"}</span>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span>{perfilAtivo === "pessoal" ? "Receita" : "Faturamento"}</span>
              </div>
            </Button>
                ...
                {tipoLancamento === "despesa"
                  ...
                  : tipoLancamento === "receita"
                    ? perfilAtivo === "pessoal"
                      ...
                      : "Receita"
                    : "Transferência"}{" "}
                - {perfilAtivo === "pessoal" ? "Pessoal" : "Profissional"}
              </span>
            </div>
            <Button variant="ghost" size="sm" onClick={handleClose}>
              <X className="w-4 h-4" />
              ...
              <Input
                ...
                placeholder={
                  perfilAtivo === "pessoal"
                    ...
                    : "Ex: Aluguel consultório, Honorários, etc."
                }
                value={descricao}
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span>Perfil:</span>
                    <Badge variant="outline" className={perfilAtivo === "pessoal" ? "text-green-600" : "text-blue-600"}>
                      {perfilAtivo === "pessoal" ? "Pessoal" : "Profissional"}
                    </Badge>
                  </div>
                  <div className="flex justify-between">
